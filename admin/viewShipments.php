...
$shipquery = mysqli_query($con, $sqlship);
...
if (isset($_POST['submit'])) {
    ...
    $upsql = "INSERT into shipments (tracking_id,products,details,status,location,estimated_delivery,delivery_fee,sender_address,sender_name,sender_phone,receiver_address,receiver_name,receiver_phone,weightt,lengthh,mode_of_payment) VALUES ('$tracking_number','$products','$details','$status','$location','$estimated_delivery','$delivery_fee','$sender_address','$sender_name','$sender_phone','$receiver_address','$receiver_name','$receiver_phone','$weight','$length','$mode_of_payment')";
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="weight" class="form-control" id="exampleInputbtc"
                                    placeholder="Enter Details" value="<?php echo $usereu['weight']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputbtc">Length</label>
                                <input type="text" name="length" class="form-control" id="exampleInputbtc"
                                    placeholder="Enter length" value="<?php echo $usereu['length']; ?>">
                            </div>
                            <div class="form-group">
